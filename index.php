...
include_once 'application/default/core/Controller.class.php';//控制器的父类
include_once 'application/default/core/Model.class.php';//模型的父类
include 'application/default/configs/config.php';//配置文件
...
if($urlModel == 1)
{
	...
	$arr = explode("/",$url);
	//获得$arr中入口文件的下标
	$index = array_search("index.php",$arr);
	//获得控制器和方法
	if($index)
	{
...
include_once 'application/default/controller/'.$c.'.class.php';
$controller = new $c();
$controller->$a();
